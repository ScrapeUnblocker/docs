...
Your endpoint, with your key in the URL:

```
https://mcp.scrapeunblocker.com/mcp?key=YOUR_API_KEY
```

**Add it on claude.ai:** Settings → Connectors → **Add custom connector**, then paste
the URL above (with your key). Save, and the tools appear everywhere you use Claude.

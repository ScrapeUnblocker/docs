...
<CardGroup cols={1}>
  <Card title="POST /getPageSource" icon="globe" href="/api-reference/endpoint/get-page-source-getpagesource-post">
  ...
  <Card title="POST /serpApi" icon="magnifying-glass" href="/api-reference/endpoint/run-serp-serpapi-post">
  ...
  <Card title="POST /getImage" icon="image" href="/api-reference/endpoint/get-image-getimage-post">
